      ...
      <div className="mx-auto max-w-7xl px-4 py-10 sm:px-6">
        <div className="flex flex-col items-center justify-between gap-6 sm:flex-row">
          ...
          <div className="flex items-center gap-5 text-sm text-zinc-600">
            ...
            <Link href="mailto:hello@metawork.network" className="flex items-center gap-2 hover:text-zinc-900">
              <Mail size={18} /> Email
            </Link>
          </div>
        </div>
        <p className="mt-6 text-center text-xs text-zinc-500">© {new Date().getFullYear()} Metawork. All rights reserved.</p>
      </div>
    </footer>
  );
}
