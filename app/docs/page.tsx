export default function DocsPage() {
  return (
    <div className="mx-auto max-w-3xl px-4 py-16">
      <h1 className="text-3xl font-bold tracking-tight">Metawork Documentation</h1>
      <p className="mt-2 text-zinc-600">Simulated documentation content.</p>

      <div className="mt-8 space-y-8">
        <section>
          <h2 className="text-2xl font-semibold">Metawork Marketplace Features</h2>
        ...
        <section>
          ...
          <p className="mt-3 text-zinc-700">
            Metawork operates on a performance-based model, aligning incentives between advertisers and affiliates. Advertisers pay for
